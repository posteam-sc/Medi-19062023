...
namespace POS
{
    public partial class GiftCardControl : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (controller.GiftCard.Add || MemberShip.isAdmin)
            {
                ...
                if (!hasError)
                {
                    ...
                    GiftCard giftCardObj2 = (from gC in posEntity.GiftCards where gC.CardNumber == txtCardNumber.Text select gC).FirstOrDefault();
        ...
        private void DataBind()
        {
            ...
            dgvGiftCardList.DataSource = posEntity.GiftCards.ToList();
        }
