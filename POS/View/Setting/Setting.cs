...
namespace POS
{
    public partial class Setting : Form
    {
        ...
        private void Setting_Load(object sender, EventArgs e)
        {
            ...
            #region Birthday Discount

            txtBirthdayDiscount.Text = SettingController.birthday_discount.ToString();
            #endregion
            #region currency
            ...
            #region SAP
            chkSAP.Checked = SettingController.DisabledImportExport;
            #endregion
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (!hasError)
            {
                ...
                if (!string.IsNullOrEmpty(txtBirthdayDiscount.Text))
                {
                    SettingController.birthday_discount = Convert.ToDecimal(txtBirthdayDiscount.Text);
                    Sales.birthdayDiscount = Convert.ToDecimal(txtBirthdayDiscount.Text);
                }
                ...
                bool previousState = SettingController.DisabledImportExport;
                SettingController.DisabledImportExport = chkSAP.Checked;
                MessageBox.Show("Successfully Saved!");
                this.Dispose();

                if (previousState != chkSAP.Checked)
                {
                    Application.Restart();
        ...
        {
            if (SettingController.AdminShop)
            {
        ...
        private void txtBirthdayDiscount_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) &&
        (e.KeyChar != '.'))
            {
