...
namespace POS
{
    public partial class TaxesSummary : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            ReportParameter TaxReportTitle = new ReportParameter("TaxReportTitle", gbList.Text + " for " + SettingController.DefaultShop.ShopName);
        ...
        private void LoadData()
        {
            ...
            foreach (SelectTaxesListByDate_Result r in resultList)
            {
                ...
                t.DateTime = Convert.ToDateTime(r.TDate);
