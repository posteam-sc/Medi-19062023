    ...
    public partial class RefundDetail : Form
    {
        ...
        private void RefundDetail_Load(object sender, EventArgs e)
        {
            ...
            if (!IsRefund)
            {
                ...
                lblCounter.Text = refundTransactionDetail.Counter.Name;
                lblDate.Text = refundTransactionDetail.DateTime.ToString("dd-MM-yyyy");
                lblTime.Text = refundTransactionDetail.DateTime.ToString("hh:mm");
