    ...
    public partial class Loc_PaidByCredit : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (!hasError)
            {
                ...
                {
                    Id = entity.InsertTransaction(DateTime.Now, MemberShip.UserId, MemberShip.CounterId, TransactionType.Sale, true, true, 1, ExtraTax + Tax, ExtraDiscount + Discount, actualCost, totalCost, null, customerId, SettingController.DefaultShop.ShortCode, SettingController.DefaultShop.Id, false);
