        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (!hasError)
            {
                ...
                if (!isDebt)
                {
                    ...
                    Id = entity.InsertTransaction(DateTime.Now, MemberShip.UserId, MemberShip.CounterId, TransactionType.Sale, true, true, 1, ExtraTax + Tax, ExtraDiscount + Discount, totalCashSaleAmount, receiveAmount, null, CustomerId, SettingController.DefaultShop.ShortCode, SettingController.DefaultShop.Id, false);
