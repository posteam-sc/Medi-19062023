...
namespace POS
{
    public partial class PurchaseOrderItem : Form
    {
        ...
        private void ShowReportViewer()
        {
            ...
            ReportParameter OrderTitle = new ReportParameter("OrderTitle", "Reorder Point for " + SettingController.DefaultShop.ShopName);
            // string _counter = Utility.Counter_Check(cboCounter);
            // ReportParameter OrderTitle = new ReportParameter("OrderTitle", "Reorder Point for " + _counter);
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            ReportParameter OrderTitle = new ReportParameter("OrderTitle", gbTitle.Text + " for " + SettingController.DefaultShop.ShopName);
