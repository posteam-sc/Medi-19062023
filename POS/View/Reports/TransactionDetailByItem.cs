...
namespace POS
{
    public partial class TransactionDetailByItem : Form
    {
        ...
        private void cboLine_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void LoadData()
        {
            ...
            else if (MainCategoryId > 0 && SubCategoryId == 0 && LineId > 0)
            {
                ...
                resultList = entity.TransactionDetailReportByBIdAndCId(fromDate, toDate, IsSale, LineId, MainCategoryId, CityId, CounterId);
            ...
            else if (MainCategoryId == 0 && SubCategoryId == 0 && LineId > 0)
            {
                ...
                resultList = entity.TransactionDetailReportByBId(fromDate, toDate, IsSale, LineId, CityId, CounterId);
            ...
            else if (MainCategoryId > 0 && SubCategoryId > 0 && LineId > 0)
            {
                ...
                resultList = entity.TransactionDetailReportByBIdAndCIdAndSCId(fromDate, toDate, IsSale, LineId, MainCategoryId, SubCategoryId, CityId, CounterId);
