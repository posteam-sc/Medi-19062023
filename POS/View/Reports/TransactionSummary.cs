...
namespace POS
{
    public partial class TransactionSummary : Form
    {
        ...
        private void LoadData()
        {
            ...
            transList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.Sale && (t.PaymentType.Name == "Cash" || t.PaymentType.Name == "Gift Card") && (t.IsDeleted == null || t.IsDeleted == false) && ((counterId == 0 && 1 == 1) || (counterId != 0 && t.CounterId == counterId)) select t).ToList<Transaction>();
            ...
            TesterList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.Sale && t.PaymentType.Name == "Tester" && (t.IsDeleted == null || t.IsDeleted == false) && ((counterId == 0 && 1 == 1) || (counterId != 0 && t.CounterId == counterId)) select t).ToList<Transaction>();
            ...
            MPUtransList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.Sale && t.PaymentType.Name == "MPU Card" && (t.IsDeleted == null || t.IsDeleted == false) && ((counterId == 0 && 1 == 1) || (counterId != 0 && t.CounterId == counterId)) select t).ToList<Transaction>();
            FOCtrnsList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.Sale && t.PaymentType.Name == "FOC" && (t.IsDeleted == null || t.IsDeleted == false) && ((counterId == 0 && 1 == 1) || (counterId != 0 && t.CounterId == counterId)) select t).ToList<Transaction>();
            ShowReportViewer1();
        ...
        private void ShowReportViewer1()
        {
            ...
            totalSale = (from t in entity.TransactionPaymentDetails
                         join td in entity.Transactions on t.TransactionId equals td.Id
                         join p in entity.PaymentMethods on t.PaymentMethodId equals p.Id
                         where EntityFunctions.TruncateTime((DateTime)td.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)td.DateTime) <= toDate
                         && td.IsDeleted == false && p.Name == "Cash" && ((counterId == 0 && 1 == 1) || (counterId != 0 && td.CounterId == counterId))
            ...
            foreach (Transaction t in transList)
            {
                ...
                //if (t.PaymentType.Name == "Gift Card")
                //{
            ...
            //                                                         join p in entity.PaymentMethods on t.PaymentMethodId equals p.Id
            //                                                         where EntityFunctions.TruncateTime((DateTime)td.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)td.DateTime) <= toDate
            //                                                         && td.IsDeleted == false && p.PaymentTypeId == 3 && ((counterId == 0 && 1 == 1) || (counterId != 0 && td.CounterId == counterId))
            //                                                         select t.Amount).ToList().Sum();

            totalMPU = (from t in entity.TransactionPaymentDetails
                        join td in entity.Transactions on t.TransactionId equals td.Id
                        join p in entity.PaymentMethods on t.PaymentMethodId equals p.Id
                        where EntityFunctions.TruncateTime((DateTime)td.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)td.DateTime) <= toDate
                        && td.IsDeleted == false && p.PaymentTypeId == 3 && ((counterId == 0 && 1 == 1) || (counterId != 0 && td.CounterId == counterId))
            ...
            totalBankTransfer = (from t in entity.TransactionPaymentDetails
                                 ...
                                 join p in entity.PaymentMethods on t.PaymentMethodId equals p.Id
                                 where EntityFunctions.TruncateTime((DateTime)td.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)td.DateTime) <= toDate
                                 && td.IsDeleted == false && p.PaymentTypeId == 5 && ((counterId == 0 && 1 == 1) || (counterId != 0 && td.CounterId == counterId))
                                 select t.Amount).ToList().Sum();
            totalPay = (from t in entity.TransactionPaymentDetails
                        join td in entity.Transactions on t.TransactionId equals td.Id
                        join p in entity.PaymentMethods on t.PaymentMethodId equals p.Id
                        where EntityFunctions.TruncateTime((DateTime)td.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)td.DateTime) <= toDate
                        && td.IsDeleted == false && p.PaymentTypeId == 6 && ((counterId == 0 && 1 == 1) || (counterId != 0 && td.CounterId == counterId))
                        select t.Amount).ToList().Sum();
            totalGlobalCard = (from t in entity.TransactionPaymentDetails
                               join td in entity.Transactions on t.TransactionId equals td.Id
                               join p in entity.PaymentMethods on t.PaymentMethodId equals p.Id
                               where EntityFunctions.TruncateTime((DateTime)td.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)td.DateTime) <= toDate
                               && td.IsDeleted == false && (p.PaymentTypeId == 4 || p.PaymentTypeId == 9 || p.PaymentTypeId == 10) && ((counterId == 0 && 1 == 1) || (counterId != 0 && td.CounterId == counterId))
                               select t.Amount).ToList().Sum();
            ...
            ReportParameter TotalSale = new ReportParameter("TotalSale", (totalSale + totalGiftCard ).ToString());
            reportViewer1.LocalReport.SetParameters(TotalSale);
