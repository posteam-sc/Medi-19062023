    ...
    public partial class SaleByRangeAndSegment : Form
    {
        ...
        private void LoadData()
        {
            ...
            if (_status == true)
            {
                ...
                {
                    #region Range
                    System.Data.Objects.ObjectResult<GetSaleByRangeWithSaleTrueValue_Result> RList = entity.GetSaleByRangeWithSaleTrueValue(fromDate, toDate, Year, CityId, CounterId);
                    ...
                    foreach (SaleByRangeOrSegmentController sb in ResultList2)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionByCustomerId_Result> splist = entity.GetSaleSpecialPromotionByCustomerId(fromDate, toDate, 0, sb.Id, false, CityId, CounterId);
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionByCustomerId_Result> splist2 = entity.GetSaleSpecialPromotionByCustomerId(yt, toDate, 0, sb.Id, false, CityId, CounterId);
                    ...
                    #region Segment
                    System.Data.Objects.ObjectResult<GetSaleBySegmentWithSaleTrueValue_Result> SList = entity.GetSaleBySegmentWithSaleTrueValue(fromDate, toDate, Year, CityId, CounterId);
                    ...
                    foreach (SaleByRangeOrSegmentController sb in ResultSegmentList)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSegmentByCustomerId_Result> splist = entity.GetSaleSpecialPromotionSegmentByCustomerId(fromDate, toDate, 0, sb.Id, false, CityId, CounterId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSegmentByCustomerId_Result> splist2 = entity.GetSaleSpecialPromotionSegmentByCustomerId(yt, toDate, 0, sb.Id, false, CityId, CounterId);
                        List<SpecialPromotionController> SPCList2 = new List<SpecialPromotionController>();
                    ...
                    foreach (SaleByRangeOrSegmentController sb in ResultSubSegmentList)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSubSegmentByCustomerId_Result> splist = entity.GetSaleSpecialPromotionSubSegmentByCustomerId(fromDate, toDate, 0, sb.Id, false, CityId, CounterId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSubSegmentByCustomerId_Result> splist2 = entity.GetSaleSpecialPromotionSubSegmentByCustomerId(yt, toDate, 0, sb.Id, false, CityId, CounterId);
                        List<SpecialPromotionController> SPCList2 = new List<SpecialPromotionController>();
                ...
                {
                    #region Range
                    System.Data.Objects.ObjectResult<GetSaleByRangeWithDiscountedValue_Result> RList = entity.GetSaleByRangeWithDiscountedValue(fromDate, toDate, Year, CityId, CounterId);
                    List<SaleByRangeOrSegmentController> ResultList2 = new List<SaleByRangeOrSegmentController>();
                    ...
                    foreach (SaleByRangeOrSegmentController sb in ResultList2)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionByCustomerId_Result> splist = entity.GetSaleSpecialPromotionByCustomerId(fromDate, toDate, 0, sb.Id, true, CityId, CounterId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionByCustomerId_Result> splist2 = entity.GetSaleSpecialPromotionByCustomerId(yt, toDate, 0, sb.Id, true, CityId, CounterId);
                        List<SpecialPromotionController> SPCList2 = new List<SpecialPromotionController>();
                    ...
                    #endregion
                    #region Segment
                    System.Data.Objects.ObjectResult<GetSaleBySegmentWithDiscountedValue_Result> SList = entity.GetSaleBySegmentWithDiscountedValue(fromDate, toDate, Year, CityId, CounterId);
                    List<SaleByRangeOrSegmentController> ResultSegmentList = new List<SaleByRangeOrSegmentController>();
                    ...
                    foreach (SaleByRangeOrSegmentController sb in ResultSegmentList)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSegmentByCustomerId_Result> splist = entity.GetSaleSpecialPromotionSegmentByCustomerId(fromDate, toDate, 0, sb.Id, true, CityId, CounterId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSegmentByCustomerId_Result> splist2 = entity.GetSaleSpecialPromotionSegmentByCustomerId(yt, toDate, 0, sb.Id, true, CityId, CounterId);
                        List<SpecialPromotionController> SPCList2 = new List<SpecialPromotionController>();
                    ...
                    #endregion
                    #region SubSegement
                    System.Data.Objects.ObjectResult<GetSaleBySubSegmentWithDiscountedValue_Result> SubSList = entity.GetSaleBySubSegmentWithDiscountedValue(fromDate, toDate, Year, CityId, CounterId);
                    List<SaleByRangeOrSegmentController> ResultSubSegmentList = new List<SaleByRangeOrSegmentController>();
                    ...
                    foreach (SaleByRangeOrSegmentController sb in ResultSubSegmentList)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSubSegmentByCustomerId_Result> splist = entity.GetSaleSpecialPromotionSubSegmentByCustomerId(fromDate, toDate, 0, sb.Id, true, CityId, CounterId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSubSegmentByCustomerId_Result> splist2 = entity.GetSaleSpecialPromotionSubSegmentByCustomerId(yt, toDate, 0, sb.Id, true, CityId, CounterId);
                        List<SpecialPromotionController> SPCList2 = new List<SpecialPromotionController>();
        ...
        private void ShowReportViewer()
        {
            ...
            string fromDate1 = yt.ToString("MM/dd/yy");
            //string fromDate2 = yt.ToString("MM/dd/yy");
            ...
            ReportParameter SubTitle = new ReportParameter("SubTitle", "( " + fDate + " - " + tDate + " & " + fromDate1 + " - " + tDate + " )");
            ...
            ReportParameter Date2Header = new ReportParameter("Date2Header", fromDate1 + "-" + tDate);
