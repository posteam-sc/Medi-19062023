            ...
            if (IsRange)
            {
                ...
                if (IsSaleTrue)
                {
                    ...
                    foreach (SaleBreakDownByRangeWithSaleTrueValue_Result r in rList)
                    {
                        ...
                        saleObj.lId = Convert.ToInt32(r.Id);
                        saleObj.Name = r.Name;
                    ...
                    {
                        SaleBreakDownController saleObj = new SaleBreakDownController();
                        saleObj.lId = Convert.ToInt32(sp.Id);
                    ...
                    foreach (SaleBreakDownController sb in ResultList2)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionByCustomerId_Result> splist = entity.GetSaleSpecialPromotionByCustomerId(fromDate, toDate, cusTypeId, sb.lId, true, CityId, CountryId);
                ...
                else
                {
                    ...
                    foreach (SaleBreakDownController sb in ResultList2)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionByCustomerId_Result> splist = entity.GetSaleSpecialPromotionByCustomerId(fromDate, toDate, cusTypeId, sb.lId, false, CityId, CountryId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
            ...
            else
            {
                ...
                if (IsSaleTrue)
                {
                    ...
                    foreach (SaleBreakDownController sb in ResultList2)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSegmentByCustomerId_Result> splist = entity.GetSaleSpecialPromotionSegmentByCustomerId(fromDate, toDate, cusTypeId, sb.lId, true, CityId, CountryId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
                ...
                else
                {
                    ...
                    foreach (SaleBreakDownController sb in ResultList2)
                    {
                        ...
                        System.Data.Objects.ObjectResult<GetSaleSpecialPromotionSegmentByCustomerId_Result> splist = entity.GetSaleSpecialPromotionSegmentByCustomerId(fromDate, toDate, cusTypeId, sb.lId, false, CityId, CountryId);
                        List<SpecialPromotionController> SPCList = new List<SpecialPromotionController>();
