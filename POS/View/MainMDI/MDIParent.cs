...
namespace POS
{
    public partial class MDIParent : Form
    {
        ...
        {
            ImportExportHistory historyForm = new ImportExportHistory();
            historyForm.ShowDialog();
        }

        private void importDataByProductToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Sales sForm = (Sales)this.ActiveMdiChild;
        ...
        private void stockInDataFromSAPToolStripMenuItem_Click(object sender, EventArgs e)
        {
            StockInFromSAP stockInForm = new StockInFromSAP();
            stockInForm.ShowDialog();
        }

        private void refreshAccessTokenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            RefreshToken tokenForm = new RefreshToken();
        ...
        private void memberTypeResetToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //if (SettingController.AdminShop)
            //{
                CustomerLevelControl CustomerLevelControlForm = new CustomerLevelControl();
                CustomerLevelControlForm.ShowDialog();

            //}
            //else
            //{
            //    MessageBox.Show("Only admin shop can perform this action");
            //}
        }
    }
}
